...
class Module extends \Application\Entity\Module implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Module' . "\0" . 'pkModuleid', '' . "\0" . 'Application\\Entity\\Module' . "\0" . 'moduleName', '' . "\0" . 'Application\\Entity\\Module' . "\0" . 'moduleCode');
        }
    ...
    public function getPkModuleid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getPkModuleid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPkModuleid', array());

        return parent::getPkModuleid();
    }
