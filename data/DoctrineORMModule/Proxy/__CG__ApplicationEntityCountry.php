...
class Country extends \Application\Entity\Country implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Country' . "\0" . 'pkCountryid', '' . "\0" . 'Application\\Entity\\Country' . "\0" . 'countryName', '' . "\0" . 'Application\\Entity\\Country' . "\0" . 'countryCode', '' . "\0" . 'Application\\Entity\\Country' . "\0" . 'nationality');
        }
    ...
    public function getPkCountryid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getPkCountryid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPkCountryid', array());

        return parent::getPkCountryid();
    }
