...
class Role extends \Application\Entity\Role implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Application\\Entity\\Role' . "\0" . 'pkRoleid', '' . "\0" . 'Application\\Entity\\Role' . "\0" . 'roleName', '' . "\0" . 'Application\\Entity\\Role' . "\0" . 'description');
        }
    ...
    public function getPkRoleid()
    {
        if ($this->__isInitialized__ === false) {
            return (int)  parent::getPkRoleid();
        }


        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getPkRoleid', array());

        return parent::getPkRoleid();
    }
